...
public class XListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mArrowImageView = (ImageView) findViewById(R.id.xlistview_header_arrow); //ImageView 箭头
        ...
        mRotateUpAnim.setDuration(ROTATE_ANIM_DURATION);// 设置动画持续的时间
        mRotateUpAnim.setFillAfter(true);//保持动画最后执行的动作
