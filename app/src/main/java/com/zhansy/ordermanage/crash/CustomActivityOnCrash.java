...
public final class CustomActivityOnCrash {
    ...
    private static int defaultErrorActivityDrawableId = R.mipmap.ic_crash;
    ...
    public static int getDefaultErrorActivityDrawableIdFromIntent(Intent intent) {
        return intent.getIntExtra(CustomActivityOnCrash.EXTRA_IMAGE_DRAWABLE_ID, R.mipmap.ic_crash);
    }
