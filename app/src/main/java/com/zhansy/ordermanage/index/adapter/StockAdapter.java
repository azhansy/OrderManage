...
//                .displayer(new RoundedBitmapDisplayer(20)) // 设置成圆角图
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.stock_item, null);
            holder.rel_restock = (RelativeLayout) convertView.findViewById(R.id.rel_restock);
        ...
        if (bean.getStock()<300){
            holder.product_stock.setTextColor(Color.parseColor("#F5551C"));
        }else if (bean.getStock()>300 && bean.getStock()<700){
            holder.product_stock.setTextColor(Color.parseColor("#F9D191"));
        }else {
            holder.product_stock.setTextColor(OMApplication.getInstance().getResources().getColor(R.color.themeApp));
        }
        return convertView;
    }
    ...
    class ViewHolder{
        ...
        public RelativeLayout rel_restock;
    }
}